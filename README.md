# Rain_dust · Yuimi exact port

本项目以 Yuimi-chaya 上游仓库锁定提交
`6b1dc0199d1fb824081f777c5f798ac933e8a94c` 为界面与交互基线，并按
`docs/HANDOFF_YUIMI_EXACT_PORT.md` 替换 Rain_dust 身份、素材和作品数据。

当前仅用于本地 Batch 1 构建与视觉验收。上游根目录未提供许可证，未确认源码、
文章和第三方素材的再发布授权前，不得部署生产站点。详见 `THIRD_PARTY.md`。
